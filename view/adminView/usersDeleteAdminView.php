        ...
        <div class="page-header" id="banner">
            <div class="row">
                <div class="col-lg-12 mx-auto">
                    ...
                    <h3>Nom de l'utilisateur : <?= $user["theuserName"] ?><br>Login: <?= $user["theuserLogin"] ?></h3>
                    <p>Droit de l'utilisateur : <?= $user["therightName"]; ?></p>
                    <div class="alert alert-danger" role="alert">
                        Voulez-vous vraiment supprimer cet utilisateur ? <a href="?p=user&delete=<?= $user["idtheuser"] ?>&confirm">OUI</a> | <a href="?p=user">NON</a>
                    </div>
                    <hr>
