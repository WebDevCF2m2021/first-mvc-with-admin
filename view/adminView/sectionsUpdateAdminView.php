                    ...
                    <div>
                        ...
                        <form action="" name="connexion" method="POST">
                            <div class="form-group">
                                <label>Titre : </label>
                                <input type="text" name="thesectionTitle" maxlength="120" class="form-control" value="<?= $section["thesectionTitle"] ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Description : </label>
                                <textarea name="thesectionDesc" maxlength="200" class="form-control" rows="3" required><?= $section["thesectionDesc"] ?></textarea>
                            </div>
